...
env = gym.make('AirfoilEnv-v0', n_params=10, max_steps=10, scale_actions = 0.3, airfoil_seed = [0.05*np.ones(10), -0.05*np.ones(10), 0.0],
               delta_reward=False, cl_reward = True, cl_reset = None, efficiency_param = 1, cl_wide = 6)
...
# Save the agent
model.save("16042024_NewRewardCl_1")
